...
<div class="form-group">
  ...
  <?php foreach ($data as $value) {?>
      <label>NIM</label>
      <input type="text" name="nim" value="<?php echo $value['nim'] ?>" class="form-control" readonly="readonly"> 
      </div>
      <div class="form-group">
      <label>Nama</label>
    ...
    <div class="form-group">
    <label>Jurusan</label>
    <input name="jurusan" type="text" value="<?php echo $value['jurusan'] ?>" class="form-control">
    </div>
<?php } ?>
